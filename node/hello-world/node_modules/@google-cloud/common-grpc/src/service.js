...
GrpcService.prototype.request = function(protoOpts, reqOpts, callback) {
  ...
  protoOpts.retryOpts = extend({
    ...
    request: function(_, onResponse) {
      respError = null;
      try {
        var decoratedReqOpts = self.decorateRequest_(reqOpts);
      } catch(e) {
        callback(e);
        return;
      }
  ...
  return retryRequest(null, protoOpts.retryOpts, function(err, resp) {
...
GrpcService.prototype.requestStream = function(protoOpts, reqOpts) {
  ...
  protoOpts.retryOpts = extend({
    ...
    request: function() {
      ...
      return service[protoOpts.method](decoratedReqOpts, grpcMetadata, grpcOpts)
  ...
  return retryRequest(null, protoOpts.retryOpts)
